...
import br.com.funcionario.exception.CargoInvalidoException;
...
public class InformacaoFuncionario {
	...
	public void casdastrarFuncionario() {
	...
	public void validarCargo(String cargo) throws CargoInvalidoException {
		if (!cargo.equalsIgnoreCase("Garçom") &&
		        !cargo.equalsIgnoreCase("Cozinheiro") &&
		        !cargo.equalsIgnoreCase("Gerente")) {
		        throw new CargoInvalidoException("Cargo inválido: " + cargo);
		    }
	}
